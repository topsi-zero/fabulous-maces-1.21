...
public class EmeraldFireMaceItem extends Item {
    ...
    public EmeraldFireMaceItem(Settings settings) {
        super(settings);
    }
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        if (entity instanceof PlayerEntity player && !world.isClient()) {
            boolean hasMaceInHand =
                    player.getMainHandStack().isOf(ModItems.EMERALD_FIRE_MACE) ||
                            player.getOffHandStack().isOf(ModItems.EMERALD_FIRE_MACE);
