...
public class IronMaceItem extends Item {
    ...
    public IronMaceItem(Settings settings) {
        super(settings);
    }
    ...
    public static AttributeModifiersComponent createAttributeModifiers() {
        return AttributeModifiersComponent.builder()
                .add(
                        ...
                        new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, 5.5f, EntityAttributeModifier.Operation.ADD_VALUE),
    ...
    public boolean canRepair(ItemStack stack, ItemStack ingredient) {
        return ingredient.isOf(ModItems.IRON_ROD);
    }
